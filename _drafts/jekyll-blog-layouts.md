...
2. В корне папке созданы файлы `index.html` и `_config.yml`.
...
Весь код из файла `index.html`, кроме содержимого тега `<body>`, необходимо перенести в созданный файл макета `default.html`. 
